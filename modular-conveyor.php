            	...
            	<div class="row clearfix">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <ul class="bread-crumb clearfix">
                            ...
                            <li class="active">Modular Conveyor</li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="row clearfix">
                ...
                <div class="content-side col-lg-9 col-md-8 col-sm-12 col-xs-12">
                    ...
                    <section class="content-section services-content">
						...
						<div class="sec-title-one"><h2>Modular Conveyor</h2></div>

                        <div class="text-block">
                            <p>Modular belt conveyor is easy to install, maintain and operate because the structure is simple, the control panel is clear.

The best part of a modular belt conveyor is it can be washed down directly, another way to save time is to take off the belt, change to a new spare one then wash the dirty belt another time.
                        ...
                        <div class="row clearfix">
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                ...
                                <!-- <div class="text">The way we all became the Brady come and listen to a story about a man barely kept his family never heard to the word able this time there is no stopng us the Love Boat soon will be making another run the Love Boat in a promises onething for a eryone be from me and the card attached.</div> -->
                                   ...
                                   <li><span class="fa fa-check-square-o"></span><strong> Standard Discharge Height: </strong>3520mm</li>
                                   <li><span class="fa fa-check-square-o"></span><strong> Standard In-Feed Length: </strong> 577mm</li>
                                   <li><span class="fa fa-check-square-o"></span><strong> Standard Out-Feed Length: </strong>334mm</li>
                                   <li><span class="fa fa-check-square-o"></span><strong> Variable Speed Control: </strong>As required</li>
                                   <li><span class="fa fa-check-square-o"></span><strong> Frame Material: </strong>Stainless Steel/ Painted Steel</li>
                                   <li><span class="fa fa-check-square-o"></span><strong> Belt Material:</strong> PP(modular)</li>
                                   </ul>
